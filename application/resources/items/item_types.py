...
from application.models.items.item_types import Item_Type
...
def get_all_item_types():
    return Item_Type.query.all()

def get_item_type_by_id(item_type_id):
    return Item_Type.query.get(item_type_id)

def update_item_type(item_type_id, item_type_data):
    item_type = Item_Type.query.get(item_type_id)
    if item_type:
